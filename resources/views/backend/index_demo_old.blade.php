...
<div class="page-wrapper">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <li>
        <a href="productlist.blade.php" class="dropdown-item">Product List</a>
        </li>
        <li>
        <a href="addproduct.blade.php" class="dropdown-item">Product Add</a>
        </li>
        </ul>
        </div>
        </div>
        ...
        <a href="productlist.blade.php" class="product-img">
        <img src="assets/img/product/product22.jpg" alt="product">
        </a>
        <a href="productlist.blade.php">Apple Earpods</a>
        </td>
        <td>$891.2</td>
        </tr>
        <tr>
        ...
        <a href="productlist.blade.php">iPhone 11</a>
        </td>
        <td>$668.51</td>
        </tr>
        <tr>
        ...
        <a href="productlist.blade.php">samsung</a>
        </td>
        <td>$522.29</td>
        </tr>
        <tr>
        ...
        <a href="productlist.blade.php">Macbook Pro</a>
        </td>
        <td>$291.01</td>
        </tr>
        </tbody>
        ...
        <td class="productimgname">
        <a class="product-img" href="productlist.blade.php">
        <img src="assets/img/product/product2.jpg" alt="product">
        </a>
        <a href="productlist.blade.php">Orange</a>
        </td>
        <td>N/D</td>
        <td>Fruits</td>
        <td>12-12-2022</td>
        ...
        <a href="productlist.blade.php">Pineapple</a>
        </td>
        <td>N/D</td>
        <td>Fruits</td>
        <td>25-11-2022</td>
        ...
        <a href="productlist.blade.php">Stawberry</a>
        </td>
        <td>N/D</td>
        <td>Fruits</td>
        <td>19-11-2022</td>
        ...
        <a href="productlist.blade.php">Avocat</a>
        </td>
        <td>N/D</td>
        <td>Fruits</td>
        <td>20-11-2022</td>
