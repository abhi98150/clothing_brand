...
<img src="{{ asset('assets_admin/img/flags/us.png') }}" alt="" height="16"> English
</a>
<a href="javascript:void(0);" class="dropdown-item">
<img src="{{ asset('assets_admin/img/flags/fr.png') }}" alt="" height="16">French
</a>
<a href="javascript:void(0);" class="dropdown-item">
<img src="{{ asset('assets_admin/img/flags/es.png') }}" alt="" height="16"> Spanish
</a>
<a href="javascript:void(0);" class="dropdown-item">
<img src="{{ asset('assets_admin/img/flags/de.png') }}" alt="" height="16"> German
</a>
</div>
</li> -->
...
<!-- notifications -->
        ...
        <img src="{{ asset('assets_admin/img/icons/notification-bing.svg') }}" alt="img">
        ...
        <a href="activities.blade.php">
        <div class="media d-flex">
        <span class="avatar flex-shrink-0">
        <img alt="" src="{{ asset('assets_admin/img/profiles/avatar-02.jpg') }}">
        ...
        <div class="media d-flex">
        <span class="avatar flex-shrink-0">
        <img alt="" src="{{ asset('assets_admin/img/profiles/avatar-03.jpg') }}">
            ...
            <div class="media d-flex">
            <span class="avatar flex-shrink-0">
            <img alt="" src="{{ asset('assets_admin/img/profiles/avatar-06.jpg') }}">
            ...
            <div class="media d-flex">
            <span class="avatar flex-shrink-0">
            <img alt="" src="{{ asset('assets_admin/img/profiles/avatar-17.jpg') }}">
            ...
            <div class="media d-flex">
            <span class="avatar flex-shrink-0">
            <img alt="" src="{{ asset('assets_admin/img/profiles/avatar-13.jpg') }}">
            ...
            <a href="activities.blade.php">View all Notifications</a>
            </div>
            </div>
            </li> -->
...
<span class="user-img"><img src="{{ asset('assets_admin/img/profiles/avator1.jpg') }}" alt="">
...
<a class="dropdown-item" href="generalsettings.blade.php"><i class="me-2" data-feather="settings"></i>Settings</a>
<hr class="m-0">
...
<div class="dropdown-menu dropdown-menu-right">
<!-- <a class="dropdown-item" href="profile.blade.php">My Profile</a> -->
<!-- <a class="dropdown-item" href="generalsettings.blade.php">Settings</a> -->
<!-- <a class="dropdown-item" href="signin.blade.php">Logout</a> -->
</div>
</div>
